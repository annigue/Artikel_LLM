...
- Auto-Repair (Expand/Kürzen/Du/Struktur/SEO), bis zu 6 Versuche
- Reiseziel-Mini-Story zu Beginn von „Hintergrund & Tipps“
...
# Ensure ANTHROPIC_API_KEY is set
 ...
 #   print("Die Umgebungsvariable 'ANTHROPIC_API_KEY' fehlt. Bitte in .env setzen.")
 #   sys.exit(1)
...
def evaluate_quality(text: str, targets: Dict[str, Any], primary_kw: str, destination: str = "") -> Tuple[bool, Dict[str, Any]]:
    ...
    return ok, {
        ...
        "seo_meta": seo_meta,
        "coherence": coherence,
        "ich_intro_ok": ich_intro_ok                    # <<< fürs Debug-Print
    }
# -------------------- LLM Call (Claude) --------------------
